                     ...
                     <td valign="top" colspan='2' >
                      ...
                      if($result){
                       ...
                       foreach($result as $key=>$val){$total = $total + $val['amount'];?>
                              ...
                              <td><?php echo GetPayerName($val['payer_id'])." - ".$val['amount']." Rs"; ?></td>
                              </tr>
                              <?php }}else{echo "<tr>
                              <td colspan='7'>No expenses Found</td></tr>";} ?>
                                 <tr>
                              <td colspan="3" align="right">Total Amount To Pay : <?php echo $total." Rs";?></td>
                              ...
                              if($val['id']!=$_GET['payer']){?>
                                 <tr>
                                       <td>To <?echo $val['name']." ( ".$val['email'].")"?> :</td>
                                       <td><?php echo GetNutralisedToAmount($_GET['payer'],$val['id'],$filter);?></td>
                                       </tr>
						      <?php } } ?>
                                  <?php } ?>
                               </table>
